...
from ITimes_email import ITimes_Email
from ITimes_scheduler import ITimes_scheduler
...
class ITimes_GUI:
    ...
    def __init__(self, root):
        # build the GUI #
        self.__root = root
        self.__root.title('ITimes')
        title_label = ttk.Label(self.__root, text = 'ITimes',
        ...
        self.__scheduler = ITimes_scheduler()
